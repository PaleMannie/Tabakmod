...
public class ZigKamelStummelEntity extends ThrowableItemProjectile {

    public ZigKamelStummelEntity(EntityType<? extends ThrowableItemProjectile> pEntityType, Level pLevel) {
    ...
    public void playerTouch(Player pPlayer) {
        ...
        if(stack.is(Items.BRUSH) && pPlayer.isUsingItem()){
            ...
            pPlayer.drop(ModItems.STUMMEL_KAMEL.get().getDefaultInstance(), false);
            this.discard();
        }
    }

    @Override
    protected Item getDefaultItem() { return ModItems.STUMMEL_KAMEL.get(); }
