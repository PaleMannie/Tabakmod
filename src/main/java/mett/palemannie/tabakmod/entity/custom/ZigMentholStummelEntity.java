...
public class ZigMentholStummelEntity extends ThrowableItemProjectile {

    public ZigMentholStummelEntity(EntityType<? extends ThrowableItemProjectile> pEntityType, Level pLevel) {

        super(pEntityType, pLevel);
    }

    public ZigMentholStummelEntity(Level pLevel, LivingEntity livingEntity, ItemStack stack) {
    ...
    public void playerTouch(Player pPlayer) {
        ...
        if(stack.is(Items.BRUSH) && pPlayer.isUsingItem()){
            ...
            pPlayer.drop(ModItems.STUMMEL_MENTHOL.get().getDefaultInstance(), false);
            this.discard();
        }
    }

    @Override
    protected Item getDefaultItem() { return ModItems.STUMMEL_MENTHOL.get(); }
