...
public class ZigScheiseStummelEntity extends ThrowableItemProjectile {

    public ZigScheiseStummelEntity(EntityType<? extends ThrowableItemProjectile> pEntityType, Level pLevel) {
    ...
    public ZigScheiseStummelEntity(double x, double y, double z, Level pLevel, ItemStack stack) {
    ...
    public void playerTouch(Player pPlayer) {
        ...
        if(stack.is(Items.BRUSH) && pPlayer.isUsingItem()){
            ...
            pPlayer.drop(ModItems.STUMMEL_SCHEISE.get().getDefaultInstance(), false);
            this.discard();
        }
    }

    @Override
    protected Item getDefaultItem() { return ModItems.STUMMEL_SCHEISE.get(); }
