...
public class MenthZigarettenItem extends Item {

    public MenthZigarettenItem(Properties pProperties) { super(pProperties); }
...
//////////////////////////////////////////////////EIGENE METHODEN///////////////////////////////////////////////////////
    ...
    void ueberzugsEffekte(Player player, Level level){
        ...
        if(level instanceof ServerLevel sevel){
            player.hurtServer(sevel, level.damageSources().source(ModDamageTypes.ZIG_MENTH_SCHADEN), 0.5f);
        }

        player.playSound(ModSounds.FERTIG_GERAUCHT.get(), 1f, (float) RandomSource.create().nextInt(8, 12)/10);
    }
...
/////////////////////////////////////////////////////NUTZMETHODEN///////////////////////////////////////////////////////
            ...
            if (pLivingEntity instanceof Player pPlayer && (pRemainingUseDuration <= getUseDuration(pStack, pLivingEntity) - 15)) {
                ...
                if (pStack.getDamageValue() >= pStack.getMaxDamage()) {
                    ...
                    if(pLevel instanceof ServerLevel serverlevel) {
                        Projectile.spawnProjectileFromRotation(ZigMentholStummelEntity::new, serverlevel, ModItems.STUMMEL_MENTHOL.get().getDefaultInstance(), pPlayer, 0f, 0.5f, 10f);
                    }
    ...
    private void stopUsing(LivingEntity pUser) {
        ...
        if(pUser instanceof Player player){
            ...
            player.getCooldowns().addCooldown(ModItems.ZIGARETTE_MENTHOL.getId(),2);
        }
    }
