...
public class ModDamageTypes {
    ...
    public static final ResourceKey<DamageType> register(String name){
        return ResourceKey.create(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(TabakMod.MODID, name));
    }
    ...
    public static final ResourceKey<DamageType> KAMEL_SCHADEN =   register("kamel_schaden");
